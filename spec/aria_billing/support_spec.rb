...
# Account Communication Creation
  ...
  describe "self.gen_statement(params)",:vcr do
    it "Generates a statement based on an invoice that has not been inluded in a statement" do
      response = AriaBilling::Support.gen_statement({"acct_no" => 1})
...
# Implementation Configuration Modification

# Implementation Configuration Retrieval
